...
const DoctorRegistration = () => {
    ...
    return (
        <form onSubmit={handleSubmit(submitHandler)} method="post" className="needs-validation" noValidate autoComplete="off">
            ...
            <div className="form-group">
                <div className="col position-relative">
                    <input type="text" className={classNames("form-control",{"is-invalid": errors.mobile})} name="mobile" placeholder="Mobile (923364048021)" 
                        {...register('mobile', { 
            ...
            <div className="form-group">
                <div className="col position-relative">
                    <input type="text" className={classNames("form-control",{"is-invalid": errors.aadhar})} name="aadhar" placeholder="CNIC (4288846990820)" 
                        {...register('aadhar', { 
